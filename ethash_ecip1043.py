...
# https://ecips.ethereumclassic.org/ECIPs/ecip-1043
#
...
ecip1043_activation_epoch = 700000	# year ~10k or such
ecip1043_fixed_epoch = 0
...
def get_cache_size(block_number):
	...
	if epoch >= ecip1043_activation_epoch:
		epoch = ecip1043_fixed_epoch
...
def ecip1043(activation, fixed):
	global ecip1043_activation_epoch, ecip1043_fixed_epoch

	ecip1043_activation_epoch = activation
	ecip1043_fixed_epoch = fixed
